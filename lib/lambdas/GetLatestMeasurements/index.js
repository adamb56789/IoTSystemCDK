...
async function getLatestData(device) {
  ...
  return {
    ...
    location: titleCase(await deviceLocationPromise)
  };
}
...
function getErrorPage(error_message){
  console.log("400 error:", error_message);
  return {
      "statusCode": 400,
      "body": error_message,
      "headers": {
